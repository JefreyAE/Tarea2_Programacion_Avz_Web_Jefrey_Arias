...
if (input_province != null) {
    ...
    input_canton.addEventListener("change", () => {
        val_province = input_province.value;
        val_canton= input_canton.value;
